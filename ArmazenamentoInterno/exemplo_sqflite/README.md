...
## Modelagem de entidade relacoionamento (MER)
O bancid e dados SQLite armazena a estrutura da tabela utilizando restrições (constraints)
e tipos primitivos de dados relacionais
